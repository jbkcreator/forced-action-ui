...
import { uploadTaxDelinquency } from '../../api/admin';

export default function UploadCard({ token, onLogout, hideHeader = false }) {
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="upload-county" className="block text-xs text-slate-400 mb-1.5">County ID</label>
              <input
                id="upload-county"
                type="text"
                value={countyId}
            ...
            <div>
              <label htmlFor="upload-tax-year" className="block text-xs text-slate-400 mb-1.5">
          ...
          <div>
            <label htmlFor="upload-file" className="block text-xs text-slate-400 mb-1.5">CSV File</label>
            <div

/**
 * Subscriber feed — reset password page (fa061).
 * Route: /reset-password/:token
 * Mirror of WLResetPasswordPage using subscriber API.
 */

import { useState } from 'react';
import { useParams, useNavigate, Link } from 'react-router-dom';
import { subscriberResetPassword } from '../api/subscriber.js';

export default function SubscriberResetPasswordPage() {
  ...
  async function handleSubmit(e) {
    ...
    setError('');
    try {
      await subscriberResetPassword(token, password);
  ...
  return (
    <div className="min-h-screen bg-fa-bg-base flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <h1 className="text-lg font-semibold text-fa-text-secondary mb-6">Set new password</h1>
